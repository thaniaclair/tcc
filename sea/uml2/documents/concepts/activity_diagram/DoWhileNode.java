...
public class DoWhileNode extends LoopNode
{
    ...
    public DoWhileNode()
    {
        ...
        name(I18NProperties.getString("do.while.node.concept.name"));
    }
    ...
    {
        return I18NProperties.getString("do.while.node.concept.name");
    }
    ...
    {
        return I18NProperties.getString("do.while.node.concept.name.for.tree") + name();
    }
