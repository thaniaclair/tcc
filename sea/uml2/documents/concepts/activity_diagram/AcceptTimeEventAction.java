...
public class AcceptTimeEventAction extends Concept
{
    
    /**
     * The serial version UID.
     */
    private static final long serialVersionUID = 4792836586075467129L;

    /**
     * Official constructor.
     */
    public AcceptTimeEventAction()
    {
        super();
        name(I18NProperties.getString("accept.time.event.action.concept.name"));
    }
    ...
    {
        return I18NProperties.getString("accept.time.event.action.concept.name");
    }
    ...
    {
        return I18NProperties.getString("accept.time.event.action.concept.name.for.tree") + name();
    }
