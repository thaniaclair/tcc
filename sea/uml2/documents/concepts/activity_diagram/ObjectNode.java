...
public class ObjectNode extends Concept
{
    ...
    {
        super();
        name(I18NProperties.getString("object.node.concept.name"));
    }
    ...
    {
        return I18NProperties.getString("object.node.concept.name");
    }
    ...
    {
        return I18NProperties.getString("object.node.concept.name.for.tree") + name();
    }
