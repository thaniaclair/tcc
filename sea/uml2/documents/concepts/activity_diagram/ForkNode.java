...
public class ForkNode extends Concept
{

    /**
     * The serial version UID.
     */
    private static final long serialVersionUID = 64345283479944388L;
    ...
    {
        super();
        name(I18NProperties.getString("fork.node.concept.name"));
    }
    ...
    {
        return I18NProperties.getString("fork.node.concept.name");
    }
    ...
    {
        return I18NProperties.getString("fork.node.concept.name.for.tree") + name();
    }
