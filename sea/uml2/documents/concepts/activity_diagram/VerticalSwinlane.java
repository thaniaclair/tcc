...
public class VerticalSwinlane extends Concept
{

    /**
     * The serial version UID.
     */
    private static final long serialVersionUID = -1192178304855209850L;

    /**
     * Official constructor.
     */
    public VerticalSwinlane()
    {
        super();
        name(I18NProperties.getString("vertical.swinlane.concept.name"));
    }
    ...
    {
        return I18NProperties.getString("vertical.swinlane.concept.name");
    }
    ...
    {
        return I18NProperties.getString("vertical.swinlane.concept.name.for.tree") + name();
    }
