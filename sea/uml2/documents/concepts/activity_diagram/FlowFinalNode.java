...
public class FlowFinalNode extends Concept
{
    ...
    {
        super();
        name(I18NProperties.getString("flow.final.node.concept.name"));
    }
    ...
    {
        return I18NProperties.getString("flow.final.node.concept.name");
    }
    ...
    {
        return I18NProperties.getString("flow.final.node.concept.name.for.tree") + name();
    }
