...
public class Assignment extends Activity
{
    ...
    {
        super();
        name(I18NProperties.getString("assignment.concept.name"));
    }
    ...
    {
        return I18NProperties.getString("assignment.concept.name");
    }
    ...
    {
        return I18NProperties.getString("assignment.concept.name.for.tree") + name();
    }
