...
public class ConditionalNode extends LoopNode
{
    ...
    {
        super();
        super.setNodeName("conditional");
        name(I18NProperties.getString("conditional.node.concept.name"));
    }
    ...
    {
        return I18NProperties.getString("conditional.node.concept.name");
    }
    ...
    {
        return I18NProperties.getString("conditional.node.concept.name.for.tree") + name();
    }
