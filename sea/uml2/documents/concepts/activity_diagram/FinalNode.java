...
public class FinalNode extends Concept
{
    ...
    {
        super();
        name(I18NProperties.getString("final.node.concept.name"));
    }
    ...
    {
        return I18NProperties.getString("final.node.concept.name");
    }
    ...
    {
        return I18NProperties.getString("final.node.concept.name.for.tree") + name();
    }
