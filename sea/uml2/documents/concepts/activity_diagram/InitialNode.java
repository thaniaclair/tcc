...
public class InitialNode extends Concept
{
    ...
    {
        super();
        name(I18NProperties.getString("initial.node.concept.name"));
    }
    ...
    {
        return I18NProperties.getString("initial.node.concept.name");
    }
    ...
    {
        return I18NProperties.getString("initial.node.concept.name.for.tree") + name();
    }
