...
public class Comment extends Concept
{
    ...
    {
        super();
        name(I18NProperties.getString("comment.concept.name"));
    }
    ...
    {
        return I18NProperties.getString("comment.concept.name");
    }
    ...
    {
        return I18NProperties.getString("comment.concept.name.for.tree") + name();
    }
