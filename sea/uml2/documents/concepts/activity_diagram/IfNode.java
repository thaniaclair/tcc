...
public class IfNode extends SequenceNode
{
    ...
    public IfNode()
    {
        ...
        name(I18NProperties.getString("if.node.concept.name"));
    }
    ...
    {
        return I18NProperties.getString("if.node.concept.name");
    }
    ...
    {
        return I18NProperties.getString("if.node.concept.name.for.tree") + name();
    }
