...
public class LoopNode extends SequenceNode
{
    ...
    public LoopNode()
    {
        ...
        name(I18NProperties.getString("loop.node.concept.name"));
    }
    ...
    {
        return I18NProperties.getString("loop.node.concept.name");
    }
    ...
    {
        return I18NProperties.getString("loop.node.concept.name.for.tree") + name();
    }
