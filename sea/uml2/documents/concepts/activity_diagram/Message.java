...
public class Message extends Activity
{
    ...
    {
        super();
        name(I18NProperties.getString("message.activity.concept.name"));
    }
    ...
    {
        return I18NProperties.getString("message.activity.concept.name");
    }
    ...
    {
        return I18NProperties.getString("message.activity.concept.name.for.tree") + name();
    }
