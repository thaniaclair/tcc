...
public class JoinNode extends Concept
{
    ...
    {
        super();
        name(I18NProperties.getString("join.node.concept.name"));
    }
    ...
    {
        return I18NProperties.getString("join.node.concept.name");
    }
    ...
    {
        return I18NProperties.getString("join.node.concept.name.for.tree") + name();
    }
