...
public class AcceptEventAction extends Concept
{
    ...
    {
        super();
        name(I18NProperties.getString("accept.event.action.concept.name"));
    }
    ...
    {
        return I18NProperties.getString("accept.event.action.concept.name");
    }
    ...
    {
        return I18NProperties.getString("accept.event.action.concept.name.for.tree") + name();
    }
