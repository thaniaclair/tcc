...
public class WhileNode extends LoopNode
{
    ...
    {
        super();
        name(I18NProperties.getString("while.node.concept.name"));
    }
    ...
    {
        return I18NProperties.getString("while.node.concept.name");
    }
    ...
    {
        return I18NProperties.getString("while.node.concept.name.for.tree") + name();
    }
