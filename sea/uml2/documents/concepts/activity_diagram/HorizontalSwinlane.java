...
public class HorizontalSwinlane extends Concept
{
     ...
     */
    public HorizontalSwinlane()
    {
        super();
        name(I18NProperties.getString("horizontal.swinlane.concept.name"));
    }
    ...
    {
        return I18NProperties.getString("horizontal.swinlane.concept.name");
    }
    ...
    {
        return I18NProperties.getString("horizontal.swinlane.concept.name.for.tree") + name();
    }
