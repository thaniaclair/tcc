...
public class Action extends Concept
{
    ...
    {
        super();
        name(I18NProperties.getString("action.concept.name"));
    }
    ...
    {
        return I18NProperties.getString("action.concept.name");
    }
    ...
    {
        return I18NProperties.getString("action.concept.name.for.tree") + name();
    }
