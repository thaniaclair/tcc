...
public class ExceptionHandler extends Concept
{
    ...
    {
        super();
        name(I18NProperties.getString("exception.handler.concept.name"));
    }
    ...
    {
        return I18NProperties.getString("exception.handler.concept.name");
    }
    ...
    {
        return I18NProperties.getString("exception.handler.concept.name.for.tree") + name();
    }
