...
public class TaskPackage extends Activity
{
    ...
    {
        super();
        name(I18NProperties.getString("task.package.concept.name"));
    }
    ...
    {
        return I18NProperties.getString("task.package.concept.name");
    }
    ...
    {
        return I18NProperties.getString("task.package.concept.name.for.tree") + name();
    }
