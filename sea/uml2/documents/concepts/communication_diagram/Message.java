...
public class Message extends Concept
{
    ...
    {
        super();
        this.messageName = new String("message()");
        this.messageNumber = new String("1");
        this.degreeArrow = 0;
        name(I18NProperties.getString("message.concept.name"));
    }
    ...
    {
        return I18NProperties.getString("message.concept.name");
    }
    ...
    {
        return I18NProperties.getString("message.concept.name.for.tree") + name();
    }
