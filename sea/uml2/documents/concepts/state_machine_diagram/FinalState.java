...
public class FinalState extends Concept
{

    /**
     * The serial version UID.
     */
    private static final long serialVersionUID = -7866766337483011530L;
    ...
    {
        super();
        name(I18NProperties.getString("final.state.concept.name"));
    }
    ...
    {
        return I18NProperties.getString("final.state.concept.name");
    }
    ...
    {
        return I18NProperties.getString("final.state.concept.name.for.tree") + name();
    }
