...
public class EntryPoint extends Concept
{

    /**
     * The serial version UID.
     */
    private static final long serialVersionUID = -3245933407018437814L;
    ...
    {
        super();
        name(I18NProperties.getString("entry.point.concept.name"));
    }
    ...
    {
        return I18NProperties.getString("entry.point.concept.name");
    }
    ...
    {
        return I18NProperties.getString("entry.point.concept.name.for.tree") + name();
    }
