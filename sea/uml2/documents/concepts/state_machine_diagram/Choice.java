...
public class Choice extends Concept
{

    /**
     * The serial version UID.
     */
    private static final long serialVersionUID = 5452444272393310731L;
    ...
    {
        super();
        name(I18NProperties.getString("choice.concept.name"));
    }
    ...
    {
        return I18NProperties.getString("choice.concept.name");
    }
    ...
    {
        return I18NProperties.getString("choice.concept.name.for.tree") + name();
    }
