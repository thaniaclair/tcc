...
import documents.concepts.state_machine_diagram.Join;
import documents.util.I18NProperties;

public class JoinFigure extends SpecificationCompositeFigure
{

    /**
     * The serial version UID.
     */
    private static final long serialVersionUID = -2971573679282587504L;
    ...
    public void redraw()
    {
        ...
        RectangleFigure ef = new RectangleFigure()
        {
             ...
             * The serial version UID.
             */
            private static final long serialVersionUID = -2701061388870164875L;
    ...
    protected JPopupMenu createPopupMenu()
    {
        ...
        popupMenu.add(new AbstractAction(I18NProperties.getString("change.to.vertical"))
        {
            ...
            {
                JoinFigure.this.isVertical = true;
        ...
        popupMenu.add(new AbstractAction(I18NProperties.getString("change.to.horizontal"))
        {
            ...
            public void actionPerformed(ActionEvent event)
            {
                JoinFigure.this.isVertical = false;
                SingleConnector.manager().updateRedrawCode();
                concept().redraw();
            }
        });
