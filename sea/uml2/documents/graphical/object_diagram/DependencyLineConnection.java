...
/**
 * Draw a dependency line between two classes. A dependency relation is a uses-a relation with a
 * direction where the connection points to the class used by another one. The start class is
 * dependend on the end class. A DependencyLineConnection has an arrow at the end point and is
 * dotted. Currently, classes keep track themselves about other dependend classes
 */
public class DependencyLineConnection extends SpecificationLineFigure
{
     ...
     * rounding errors or incomplete last lines.java
     * 
